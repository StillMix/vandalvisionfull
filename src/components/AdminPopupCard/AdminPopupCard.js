  ...
  const mergeImages = (blobUrl1, blobUrl2) => {
    ...
    img1.onload = () => {
      ...
      if (blobUrl2) {
        ...
        // Если второго изображения нет, сохраняем только первое
        convertCanvasToWebP(canvas);
      }
    };
  };
  ...
  return (
    ...
    >
      <div className="adminpopupcard__popup">
        <div className="adminpopupcard__popup__slider">
          <div
            className={`adminpopupcard__popup__img ${
              ...
              formValues.NewImg
                ...
                : formValues.ImgInput
                ? ""
                : "adminpopupcard__popup__img__nondisable"
            }`}
            style={{
          ...
          >
            <div className="adminpopupcard__popup__img__container">
              <input
                ...
                className="adminpopupcard__popup__img__container__file-input"
                placeholder=""
                id="imageInput"
                name="imageInput"
              />
              <label htmlFor="imageInput">
                <div className="adminpopupcard__popup__img__container__content">
                  <img
                    alt="icon"
          ...
          <div
            className={`adminpopupcard__popup__img ${
              formValues.NewImgArc
                ? ""
                : formValues.ImgArcInput
                ? ""
                : "adminpopupcard__popup__img__nondisable"
            }`}
            style={{
              backgroundImage: formValues.NewImgArc
                ? `url(${formValues.NewImgArc})`
          ...
          <div className="adminpopupcard__popup__img__control">
            <img
              className={`adminpopupcard__popup__img__control__left ${
                slideDirection === "left" ? "none" : ""
              }`}
              alt="icon"
              src={Arrow}
            ...
            />
            <img
              className={`adminpopupcard__popup__img__control__right ${
                slideDirection === "left" ? "" : "none"
              }`}
              alt="icon"
              src={Arrow}
        ...
        <div className="adminpopupcard__popup__container">
          ...
          <div className="adminpopupcard__popup__container__btns">
            <button
              onClick={handleSubmit} // Вызов обработчика отправки
      ...
      {arcImg && (
        <div className={`imgpopup ${arcImgOpen ? "in" : "out"}`}>
          <div className="imgpopup__popup">
            <div
              className={`imgpopup__popup__img ${
                formValues.firstImage
                  ? ""
                  : "imgpopup__popup__img__nondisable"
              }`}
              style={{
            ...
            >
              <div className="imgpopup__popup__img__container">
                <input
                  type="file"
                  accept="image/*"
                  onChange={handleFileChange}
                  className="imgpopup__popup__img__container__file-input"
                  placeholder=""
                  id="imageInput"
                  name="imageInputOne"
                />
                <label htmlFor="imageInputOne">
                  <div className="imgpopup__popup__img__container__content">
                    <img
                      alt="icon"
                      className="imgpopup__popup__img__container__img"
                      src={NewImg}
                    />
                    <p className="imgpopup__popup__img__container__text">
            ...
            <button
              ...
              className="imgpopup__popup__bck"
            >
              Закрыть
            </button>
            <button
              onClick={() => {
                if (formValues.firstImage || formValues.lastImage) {
                  mergeImages(formValues.firstImage, formValues.lastImage); // Передаем оба изображения, если есть
                  setArcImgOpen(false);
                  setTimeout(() => {
                    setArcImg(false);
                    setFormValues((prevState) => ({
              ...
              className="imgpopup__popup__save"
