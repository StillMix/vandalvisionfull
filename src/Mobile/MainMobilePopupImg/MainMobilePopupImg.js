...
function MainMobilePopupImg(props) {
  ...
  return (
    <div className={`popupOpenImgMobile`}>
      <TransformWrapper
        defaultScale={1}
      ...
      >
        {({ zoomIn, zoomOut, resetTransform }) => (
          <>
              ...
              <div className="sliderContainer">
                {images.map((src, index) => (
                  <img
                    ...
                    alt={`img-${index}`}
                    src={src}
                    className={`popupOpenImgMobile__img ${
            ...
            <div className="popupOpenImgMobile__op__containerBtn">
            <button
                className="popupOpenImgMobile__op__containerBtn__btndown"
                onClick={handleDownload}
              >
                <img
                  alt="icon"
                  src={Download}
                  className="popupOpenImgMobile__op__containerBtn__btn__img"
                />
                <span>Скачать</span>
              </button>
              <button
                className="popupOpenImgMobile__op__containerBtn__btn"
...
export default MainMobilePopupImg;
